...
<!-- saved from url=(0030)http://localhost/contribua.php -->
<html lang="pt-BR" dir="ltr" class="g-offcanvas-css3 wf-active wf-raleway-n3-active wf-raleway-n4-active"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./calendario_files/index.php" rel="stylesheet">
    <link href="./calendario_files/chosen.css" rel="stylesheet">
    <link href="./calendario_files/finder.css" rel="stylesheet">
    <link href="./calendario_files/font-awesome.min.css" rel="stylesheet">
    <link href="./calendario_files/nucleus.css" rel="stylesheet">
    <link href="./calendario_files/hydrogen_10.css" rel="stylesheet">
    <link href="./calendario_files/bootstrap-gantry.css" rel="stylesheet">
    <link href="./calendario_files/joomla.css" rel="stylesheet">
    <link href="./calendario_files/icomoon.css" rel="stylesheet">
    <link href="./calendario_files/hydrogen-joomla_10.css" rel="stylesheet">
    <link href="./calendario_files/custom_10.css" rel="stylesheet">
    <link href="./calendario_files/squeezebox.css" rel="stylesheet">
    <style>
        .margin-h-8 {
            margin: 8px;
        }
    ...
    <script src="./calendario_files/jquery.min.js"></script>
    <script src="./calendario_files/jquery-noconflict.js"></script>
    <script src="./calendario_files/jquery-migrate.min.js"></script>
    <script src="./calendario_files/caption.js"></script>
    <script src="./calendario_files/bootstrap.min.js"></script>
    <script src="./calendario_files/chosen.jquery.min.js"></script>
    <script src="./calendario_files/jquery.autocomplete.min.js"></script>
    <script src="./calendario_files/jquery.easing.min.js"></script>
    <script src="./calendario_files/squeezebox.min.js"></script>
    <script src="./calendario_files/sendmsgs.js"></script>
    <script>
    ...
    <link rel="stylesheet" type="text/css" href="./calendario_files/smartslider.min.css" media="all">
    <style type="text/css">
    ...
    <script type="text/javascript" src="./calendario_files/n2-j.min.js"></script>
    <script type="text/javascript" src="./calendario_files/nextend-gsap.min.js"></script>
    <script type="text/javascript" src="./calendario_files/nextend-frontend.min.js"></script>
    <script type="text/javascript" src="./calendario_files/smartslider-frontend.min.js"></script>
    <script type="text/javascript" src="./calendario_files/smartslider-simple-type-frontend.min.js"></script>
    <script type="text/javascript" src="./calendario_files/smartslider-backgroundanimation.min.js"></script>
    <link rel="stylesheet" href="./calendario_files/css" media="all">
    <link rel="stylesheet" href="./calendario_files/css(1)" media="all">
    <link rel="stylesheet" href="./calendario_files/css(1)" media="all">
    <link rel="stylesheet" href="./calendario_files/css(1)" media="all">
    <link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(1)" media="all"><link rel="stylesheet" href="./calendario_files/css(2)" media="all"><script type="text/javascript" src="./calendario_files/nextend-webfontloader.min.js"></script>
    <script type="text/javascript">
        N2R('documentReady', function($) {
...
<body class="gantry site com_content view-category layout-blog no-task dir-ltr itemid-101 outline-10 g-offcanvas-left g-home g-style-preset4">
    ...
    <div id="g-page-surround"><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div><div class="g-menu-overlay"></div>
        ...
        <header id="g-header">
<img src="./calendario_files/banner.png" width="100%">            
...
<li class="g-menu-item g-menu-item-210 g-menu-item-type-heading g-parent g-selected g-standard">
                                        ...
                                        <ul class="g-active g-dropdown g-dropdown-right g-fade">
                                            <li class="g-dropdown-column">
                                                <div class="g-grid">
                                                    <div class="g-block size-100">
                                                        <ul class="g-sublevel">
    ...
    <script type="text/javascript" src="./calendario_files/main.js"></script>
