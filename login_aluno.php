...
?>
<!-- saved from url=(0031)http://localhost/anteriores.php -->
<html lang="pt-BR" dir="ltr" class="g-offcanvas-css3 wf-active wf-raleway-n3-active wf-raleway-n4-active"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./login_aluno_files/index.php" rel="stylesheet">
    <link href="./login_aluno_files/chosen.css" rel="stylesheet">
    <link href="./login_aluno_files/finder.css" rel="stylesheet">
    <link href="./login_aluno_files/font-awesome.min.css" rel="stylesheet">
    <link href="./login_aluno_files/nucleus.css" rel="stylesheet">
    <link href="./login_aluno_files/hydrogen_10.css" rel="stylesheet">
    <link href="./login_aluno_files/bootstrap-gantry.css" rel="stylesheet">
    <link href="./login_aluno_files/joomla.css" rel="stylesheet">
    <link href="./login_aluno_files/icomoon.css" rel="stylesheet">
    <link href="./login_aluno_files/hydrogen-joomla_10.css" rel="stylesheet">
    <link href="./login_aluno_files/custom_10.css" rel="stylesheet">
    <link href="./login_aluno_files/squeezebox.css" rel="stylesheet">
    <style>
        .margin-h-8 {
            margin: 8px;
        }
    ...
    <link rel="stylesheet" type="text/css" href="./login_aluno_files/smartslider.min.css" media="all">
    <style type="text/css">
    ...
    <script type="text/javascript" src="./login_aluno_files/n2-j.min.js"></script>
    <script type="text/javascript" src="./login_aluno_files/nextend-gsap.min.js"></script>
    <script type="text/javascript" src="./login_aluno_files/nextend-frontend.min.js"></script>
    <script type="text/javascript" src="./login_aluno_files/smartslider-frontend.min.js"></script>
    <script type="text/javascript" src="./login_aluno_files/smartslider-simple-type-frontend.min.js"></script>
    <script type="text/javascript" src="./login_aluno_files/smartslider-backgroundanimation.min.js"></script>
    <link rel="stylesheet" href="./login_aluno_files/css" media="all">
    <link rel="stylesheet" href="./login_aluno_files/css(1)" media="all">
    <link rel="stylesheet" href="./login_aluno_files/css(1)" media="all">
    <link rel="stylesheet" href="./login_aluno_files/css(1)" media="all">
    <link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(1)" media="all"><link rel="stylesheet" href="./login_aluno_files/css(2)" media="all"><script type="text/javascript" src="./login_aluno_files/nextend-webfontloader.min.js"></script>
    <script type="text/javascript">
        N2R('documentReady', function($) {
...
<body class="gantry site com_content view-category layout-blog no-task dir-ltr itemid-101 outline-10 g-offcanvas-left g-home g-style-preset4">
	...
	<body>
		...
		<div align="center">
			<form action="login_aluno.php" method="post">
				...
				<br><br>
				<input type="submit" name="submited" value="logar">	
				<a href="registrar_aluno.php"><input id="button_link" type="button" name="registrar" value="registrar-se"></a>
				<br>
				<br>
				<a href="index.php"><input id="button_link" type="button" name="inicio" value="pagina inicial"></a>
				<br>
				<br>
			</form>
			<br>
		...
		<?php
			...
			if($submited==NULL)
				return 0;
			$requisicao =  sprintf("select * from login where senha = MD5('%s') and usuario = '%s';", $senha, $login);
			...
			else
			{
				...
				{
					printf("<span align=\"center\">N&atilde;o foi possivel conectar</span><br>");
					exit();
				}
				else
				{
					$resultado = mysqli_query($conexao,$requisicao);
					if($resultado == false)
					{	
						$mensagem = "Incorreto";
					...
					$vetor =  mysqli_fetch_array($resultado,MYSQLI_ASSOC);
					$_SESSION['login'] = $vetor['usuario'];
					$_SESSION['nome'] = $vetor['nome'];
					$_SESSION['email'] = $vetor['email'];
					$_SESSION['telefone'] = $vetor['telefone'];
					$_SESSION['senha'] = $senha;
					$_SESSION['csrf'] = uniqid();
					if(strcmp($vetor['usuario'],$login)==0)
					{
						printf("logando...");
						printf("
						<form action=\"perfil.php\" method=\"post\" id=\"ant_csrf\">
							<input type=\"hidden\" name=\"ant_csrf\" value=$csrf>
						</form>
						");
						printf("
						<script type=\"text/javascript\">
								document.getElementById('ant_csrf').submit();
						</script>
						");
					}
					else
    ...
    <script type="text/javascript" src="./login_aluno_files/main.js"></script>
...
<div class="autocomplete-suggestions" style="position: absolute; display: none; width: 300px; max-height: 400px; z-index: 9999;"></div><div style="font-size:10rem;"></div>
<div class="autocomplete-suggestions" style="position: absolute; display: none; width: 300px; max-height: 400px; z-index: 9999;"></div><div style="font-size:10rem;"></div>
<div class="autocomplete-suggestions" style="position: absolute; display: none; width: 300px; max-height: 400px; z-index: 9999;"></div><div class="autocomplete-suggestions" style="position: absolute; display: none; width: 300px; max-height: 400px; z-index: 9999;"></div></body></html>
